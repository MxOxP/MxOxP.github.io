...
function func_ShowRotation() {
	dialogRotation = new bootbox.dialog({
		title: "<span id='tituloRotacion'>ALERTA</span>",
		message: "<p class='content-rotacion'>Para tener una mejor experiencia coloca tu dispositivo en una posición horizontal.</p><div><img src='../resources/img/girar_dispositivo.gif' alt='rotacion' id='rotacion' class='img-fluid'></div>",
		size: 'sm',
		closeButton: false,
		show: false
	});
